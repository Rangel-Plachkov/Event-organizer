...
class PHPMailer
{
    ...
    /**
     * Set the View and private key files and password for S/MIME signing.
     *
    ...
    /**
     * Allows for View read access to 'to' property.
    ...
    /**
     * Allows for View read access to 'cc' property.
     * Before the send() call, queued addresses (i.e. with IDN) are not yet included.
     *
     * @return array
     */
    ...
    /**
     * Allows for View read access to 'bcc' property.
     * Before the send() call, queued addresses (i.e. with IDN) are not yet included.
     *
     * @return array
     */
    ...
    /**
     * Allows for View read access to 'ReplyTo' property.
     * Before the send() call, queued addresses (i.e. with IDN) are not yet included.
     *
     * @return array
     */
    ...
    /**
     * Allows for View read access to 'all_recipients' property.
     * Before the send() call, queued addresses (i.e. with IDN) are not yet included.
     *
     * @return array
     */
